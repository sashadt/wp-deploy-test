                        ...
                        <div class="blog-post-item">
                            <div class="row">
                                <div class="medium-3 columns">
    								<a href="<?php the_field('news_source_url'); ?>" target="_blank"><img src="<?php the_field('source_logo'); ?>" alt=""></a>
                                </div>
                                <div class="medium-9 columns">
                                    <p class="blog-post-date"><?php the_time('j F Y'); ?> | <?php the_field('news_source'); ?></p>
                                    <h4><a href="<?php the_field('news_source_url'); ?>" target="_blank"><?php the_title(); ?></a></h4>
