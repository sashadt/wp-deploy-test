                            ...
                            <div class="blog-post-item">
                                <div class="row">
                                    ...
                                    <div class="medium-8 columns">
                                        <h4><?php the_title(); ?></h4>
                                        <?php the_content(); ?><a class="" href="<?php the_field('website_link'); ?>" target="_blank">Visit Website </a>
                                        <?php if(get_field('board_member_name')) { ?>
                                            | Board Member : <a class="" href="<?php the_field('board_member_link'); ?>" target="_blank"><?php the_field('board_member_name'); ?></a>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
