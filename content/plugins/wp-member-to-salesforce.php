...
function mem_save_sf_lead( $fields ) {
  ...
  $post['company'] = $fields['company'];
  $post['oid']             = '00Di0000000fuQS'; //set your OID number here
  $post['lead_source']  =  'Web - Registration'; //  get_bloginfo('url'); //change the lead source if you don't want it to be the url of your site
  $post['debug']            = 0;
  ...
  // $result = wp_remote_post('https://na15.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8', $args);
