...
Description: Allows to create your own widgetized areas and custom sidebars, and select what sidebars to use for each post or page. SPARK3 EDIT: changed permissions to 'edit_pages' so editor-level accounts can manage sidebars.
Version: 1.4
Author: WPMUDEV and SPARK3
